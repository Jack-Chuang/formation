...
class go_to_Goal:
    ...
    def go_to_goal(self, x_goal, y_goal):
        ...
        self.follower1.linear.x = 0
        self.follower1.angular.z = 0
        self.pub_vel_1.publish(self.follower1)

        self.follower2.linear.x = 0
        self.follower2.angular.z = 0
        self.pub_vel_2.publish(self.follower2)
