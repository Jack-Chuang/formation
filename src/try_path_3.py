...
class go_to_Goal:
    ...
    def turtle_vel_1(self, msg):
        self.msg = msg
        self.vel_1_linear = self.msg.linear.x
        self.vel_1_angular = self.msg.angular.z
    
    def turtle_vel_2(self, msg):
        self.msg = msg
        self.vel_2_linear = self.msg.linear.x
        self.vel_2_angular = self.msg.angular.z
...
if __name__ == '__main__':
    ...
    rospy.init_node('turtlesim_motion_pose_3', anonymous=True)
    try:
        f = go_to_Goal()
